// lib/projectCards.ts
// Fuente única de las tarjetas de case study.
//
// Antes esta lista vivía hardcodeada dentro de app/api/projects/route.ts y la
// página /projects la pedía por fetch dentro de un useEffect. El efecto lateral
// era que el HTML servido no contenía ni un solo case study: los crawlers que no
// ejecutan JavaScript (la mayoría de los de IA) veían la página vacía.
//
// Ahora la lista se arma en el servidor y la página la recibe ya renderizada.
// La API sigue existiendo con la misma respuesta para no romper a quien la
// consuma, pero ambos leen de acá.
...
function loadTranslations(lang: CardLanguage) {
  try {
    return require(`../locales/${lang}/projects.json`);
  } catch {
    return require(`../locales/en/projects.json`);
  }
}

/** Devuelve las tarjetas ya traducidas al idioma pedido. */
export function getProjectCards(lang: CardLanguage = 'en'): ProjectCard[] {
  ...
  {
    slug: 'globaly',
    title: t('projects.items.globaly.title'),
    isTutorial: false,
    description: t('projects.items.globaly.description'),
    link2: null,
    link3: 'https://getglobaly.com',
    previewImage: '/img/img/globaly-web/globaly-01.webp',
    technologies: ['Next.js 16', 'React 19', 'TypeScript', 'Tailwind CSS v4', 'next-intl', 'Strapi', 'Zod', 'Postmark', 'JSON-LD', 'Docker', 'Bitbucket Pipelines', 'Cloudflare'],
    category: 'landing',
    status: 'latest',
    featured: true,
  },
  {
    ...
    title: t('projects.items.red-lizard-studioz.title'),
    isTutorial: false,
    description: t('projects.items.red-lizard-studioz.description'),
    link2: null,
    link3: null,
    previewImage: '/img/img/redlizard-web/redlizard-01.webp',
    technologies: ['Next.js 15', 'React 19', 'TypeScript', 'Tailwind CSS 4', 'TanStack Query', 'Strapi 5', 'Node.js', 'PostgreSQL 17', 'pgvector', 'OpenAI SDK', 'AG-UI (SSE)', 'Google OAuth', 'JWT', 'Postmark', 'Docker', 'Linode', 'Cloudflare'],
    category: 'platform',
    status: 'latest',
    featured: true,
  },
  {
    slug: 'comply-dq-site',
    title: t('projects.items.comply-dq-site.title'),
    isTutorial: false,
    description: t('projects.items.comply-dq-site.description'),
    link2: null,
    link3: 'https://www.complydq.com',
    previewImage: '/img/img/cdq-site-web/cdqsite-01.webp',
    technologies: ['Next.js 16', 'React 19', 'TypeScript', 'CSS Modules', 'Strapi 5', 'DOMPurify', 'Docker', 'nginx', 'Cloudflare', 'Bitbucket Pipelines'],
    category: 'landing',
    status: 'latest',
    featured: true,
  },
  {
    ...
    title: t('projects.items.royal-parking-services.title'),
    isTutorial: false,
    description: t('projects.items.royal-parking-services.description'),
    link2: null,
    link3: null,
  ...
  },
  {
    ...
    title: t('projects.items.sophie-callander.title'),
    isTutorial: false,
    description: t('projects.items.sophie-callander.description'),
    link2: null,
    link3: 'https://sophiecallander.com',
