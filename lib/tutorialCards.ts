// lib/tutorialCards.ts
// Fuente única de los tutoriales.
//
// Igual que con los case studies: la lista estaba hardcodeada dentro de la ruta
// de API y /tutorials la pedía por fetch al montar, así que el HTML servido no
// contenía ningún tutorial. Ahora se renderiza en el servidor.
