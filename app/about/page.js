  ...
  return (
    <div className="about-container">
      ...
      <section className='sub-description'>
        <p>
          I'm a passionate and dedicated <u><strong>Web Developer</strong></u> with solid knowledge in <u><strong>JavaScript</strong></u> and modern frameworks. 
          ...
          I'm always eager to embrace <u>new technologies</u> and approaches to solve complex problems efficiently.
        </p>
      </section>   
      <section className="experience-section">    {/* Experience Section */}
        <h2>Experience</h2>
        <p>
            I've developed and launched several web applications focusing on enhancing user experience, ensuring scalability and integrating them with databases.
        </p>
        <p>
        ...
        <p>
            Additionally, I've worked on many personal full-stack applications projects, refining my skills in both frontend and backend development.
        </p>
      </section>
      ...
      <section className="contact-section"> {/* Contact Section */}
        <h2>Contact Me</h2>
        <p>
            I'm always excited to connect with fellow developers, potential clients, and creative thinkers. 
